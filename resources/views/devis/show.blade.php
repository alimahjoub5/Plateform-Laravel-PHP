                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="space-y-4 mb-6">
                            @forelse($devis->negotiations ?? [] as $negotiation)
                                <div class="flex {{ $negotiation->sender_type === 'admin' ? 'justify-end' : 'justify-start' }}">
                                    <div class="max-w-2xl {{ $negotiation->sender_type === 'admin' ? 'bg-blue-100' : 'bg-gray-100' }} rounded-lg p-4">
                                        <div class="flex items-center mb-2">
                                            <span class="text-sm font-medium {{ $negotiation->sender_type === 'admin' ? 'text-blue-800' : 'text-gray-800' }}">
                                                {{ $negotiation->sender_type === 'admin' ? 'Vous' : 'Client' }}
                                            </span>
                                        ...
                                        <p class="text-sm {{ $negotiation->sender_type === 'admin' ? 'text-blue-900' : 'text-gray-900' }}">
                                            {{ $negotiation->message }}
                                        </p>
                                    </div>
                                </div>
                        ...
                        @if($devis->Statut == 'En attente')
                            <form action="{{ route('devis.negotiate', $devis->DevisID) }}" method="POST" class="space-y-4">
                                @csrf
                                <div>
