...
@section('content')
    ...
    <!-- Hero Section -->
    <div class="bg-gradient-to-r from-purple-600 to-pink-500 text-white py-32">
        <div class="max-w-4xl mx-auto text-center animate__animated animate__fadeIn">
            ...
            <div class="space-x-4">
                <a href="{{ route('register') }}" class="bg-white text-purple-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100">Commencer</a>
                <a href="#features" class="bg-transparent border border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-purple-600">En savoir plus</a>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="animate__animated animate__fadeInLeft">
                    ...
                    <a href="{{ route('register') }}" class="bg-gradient-to-r from-purple-600 to-pink-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700">Rejoignez-nous</a>
                </div>
...
<div id="services" class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="flex justify-center gap-4 mb-8">
            <button class="filter-btn px-4 py-2 rounded-full bg-purple-500 text-white hover:bg-purple-600 transition-colors" data-category="all">Tous</button>
                ...
                <div class="service-card text-center bg-white rounded-lg shadow-md overflow-hidden transition-transform transform hover:scale-105 hover:shadow-lg animate__animated animate__fadeInUp" data-category="{{ $service->Category }}">
                    ...
                    <div class="w-full h-48 flex items-center justify-center bg-purple-50">
                        @if ($service->Category === 'Development')
                            <i class="fas fa-code text-6xl text-purple-500"></i> <!-- Icône pour Développement -->
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">
                            <span class="inline-block bg-purple-500 text-white text-sm px-2 py-1 rounded-full">
                                {{ $service->Category }}
                            </span>
                        </p>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        filterButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                filterButtons.forEach(btn => btn.classList.remove('bg-purple-500', 'text-white', 'hover:bg-purple-600'));
                ...
                button.classList.add('bg-purple-500', 'text-white', 'hover:bg-purple-600');
